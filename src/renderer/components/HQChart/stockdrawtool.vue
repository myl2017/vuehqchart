...
<script>
  import '../../vendor/jscommon/umychart.resource/font/brushSymbol.js'
  import '../../vendor/jscommon/umychart.resource/font/fontSymbol.css'
  ...
  export default {
    ...
    methods: {
      ToolBoxHandle() {
        ...
        const tw = parseInt(getStyle(toolBox, 'width')) + 2
        const th = parseInt(getStyle(toolBox, 'height')) + 2
        let isDown = false
